...
public class MediatypeService {
    ...
    public static final MediaTypeProperty XHTML = new MediaTypeProperty("application/xhtml+xml", ".xhtml",
    ...
    // images
    public static final MediaTypeProperty JPG = new MediaTypeProperty("image/jpeg", ".jpg",
            new String[] {".jpg", ".jpeg"});
