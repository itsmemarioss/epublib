...
class DOMUtil {
    ...
    /**
     * First tries to get the attribute value by doing an getAttributeNS on the element, if that gets an empty element
     * it does a getAttribute without namespace.
     * @param element
     * @param namespace
     * @param attribute
     * @return
     ...
     * findAttributeName and findAttributeValue. It then returns the value of the given resultAttributeName.
     * @param document
     * @param namespace
     * @param elementName
     ...
     * @return
     */
    public static String getFindAttributeValue(Document document, String namespace, String elementName,
                                               String findAttributeName, String findAttributeValue,
    ...
    /**
     * The contents of all Text nodes that are children of the given parentElement. The result is trim()-ed.
     * <p>
     * The reason for this more complicated procedure instead of just returning the data of the firstChild is that when
     * the text is Chinese characters then on Android each Characater is represented in the DOM as an individual Text
     * node.
     * @param parentElement
     * @return
     */
