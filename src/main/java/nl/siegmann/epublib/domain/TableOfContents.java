...
/**
 * The table of contents of the book. The TableOfContents is a tree structure at the root it is a list of TOCReferences,
 * each if which may have as children another list of TOCReferences.
 * <p>
 * The table of contents is used by epub as a quick index to chapters and sections within chapters. It may contain
 * duplicate entries, may decide to point not to certain chapters, etc.
 * <p>
...
public class TableOfContents implements Serializable {
     ...
     * @return the new TOCReference
     */
    public TOCReference addSection(Resource resource, int[] pathElements, String sectionTitlePrefix,
    ...
    private static void getAllUniqueResources(Set<String> uniqueHrefs, List<Resource> result,
