...
/**
 * This class represents a member of a zip archive. ZipFile and ZipInputStream will give you instances of this class as
 * information about the members in an archive. On the other hand ZipOutputStream needs an instance of this class to
 * create a new member.
...
public class ZipEntry implements ZipConstants, Cloneable {
    ...
    /**
     * Gets the hashCode of this ZipEntry. This is just the hashCode of the name. Note that the equals method isn't
     * changed, though.
     */
    @Override
    public int hashCode() {
