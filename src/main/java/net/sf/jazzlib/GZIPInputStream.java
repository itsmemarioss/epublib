...
public class GZIPInputStream extends InflaterInputStream {
     ...
     * @param in The stream to read compressed data from (in GZIP format).
     ...
     * @throws IOException              if an error occurs during an I/O operation.
     * @throws IllegalArgumentException if <code>size</code> is less than or equal to 0.
     */
     ...
     * @param buf    the buffer into which the uncompressed data will be stored.
     * @param offset the offset indicating where in <code>buf</code> the uncompressed data should be placed.
