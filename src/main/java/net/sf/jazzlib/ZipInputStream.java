...
/**
 * This is a FilterInputStream that reads the files in an zip archive one after another. It has a special method to get
 * the zip entry of the next file. The zip entry contains information about the file name size, compressed size, CRC,
 * etc.
 * <p>
...
public class ZipInputStream extends InflaterInputStream implements ZipConstants {
    ...
    /**
     * Open the next entry from the zip archive, and return its description. If the previous entry wasn't closed, this
