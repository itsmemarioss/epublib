...
public class ZipFile implements ZipConstants {
     ...
     * <p>
     * If the OPEN_DELETE mode is specified, the zip file will be deleted at some time moment after it is opened. It
     * will be deleted before the zip file is closed or the Virtual Machine exits.
     * <p>
    ...
    /**
     * Read the central directory of a zip file and fill the entries array. This is called exactly once when first
     * needed. It is called while holding the lock on <code>raf</code>.
     * @throws IOException  if a i/o error occured.
    ...
    /**
     * Checks, if the local header of the entry at index i matches the central directory, and returns the offset to the
     * data.
    ...
    /**
     * Creates an input stream reading the given zip entry as uncompressed data. Normally zip entry should be an entry
