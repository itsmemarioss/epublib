...
/**
 * This filter stream is used to decompress data compressed in the "deflate" format. The "deflate" format is described
 * in RFC 1951.
 * <p>
 * This stream may form the basis for other decompression filters, such as the <code>GZIPInputStream</code>.
 * @author John Leuner
 * @author Tom Tromey
 * @since 1.1
 */
