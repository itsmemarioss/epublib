...
class PackageDocumentMetadataReader extends PackageDocumentBase {
    ...
    public static Metadata readMetadata(Document packageDocument, Resources resources) {
        ...
        Element metadataElement = DOMUtil.getFirstElementByTagNameNS(packageDocument.getDocumentElement(),
    ...
    /**
     * consumes meta tags that have a property attribute as defined in the standard. For example: &lt;meta
     ...
     * @param date
     */
    public static void readDcmesCommonProperties(Element element, Date date) {
