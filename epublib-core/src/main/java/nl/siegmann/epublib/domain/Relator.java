...
public enum Relator {
    ...
    /**
     * Use for a person or organization who principally exhibits acting skills in a musical or dramatic presentation or
     * entertainment.
     */
    ACTOR("act", "Actor"),

    /**
     * Use for a person or organization who 1) reworks a musical composition, usually for a different medium, or 2)
    ...
    /**
     * Use for a person or organization who transcribes a musical composition, usually for a different medium from that
     * of the original; in an arrangement the musical substance remains essentially unchanged.
     */
    ...
    /**
     * Use for a person (e.g., a painter) or organization who conceives, and perhaps also implements, an original
     * graphic design or work of art, if specific codes (e.g., [egr], [etr]) are not desired. For book illustrators,
     * prefer Illustrator [ill].
     */
    ARTIST("art", "Artist"),

    /**
     * Use for a person responsible for controlling the development of the artistic style of an entire production,
    ...
    /**
     * Use for an author, artist, etc., relating him/her to a work for which there is or once was substantial authority
     * for designating that person as author, creator, etc. of the work.
     */
    ATTRIBUTED_NAME("att", "Attributed name"),

    /**
     * Use for a person or organization in charge of the estimation and public auctioning of goods, particularly books,
     * artistic works, etc.
     */
    AUCTIONEER("auc", "Auctioneer"),

    /**
     * Use for a person or organization chiefly responsible for the intellectual or artistic content of a work, usually
     * printed text. This term may also be used when more than one person or body bears such responsibility.
     */
    AUTHOR("aut", "Author"),

    /**
     * Use for a person or organization whose work is largely quoted or extracted in works to which he or she did not
    ...
    /**
     * Use for a person or organization responsible for an afterword, postface, colophon, etc. but who is not the chief
     * author of a work.
     */
    AUTHOR_OF_AFTERWORD_COLOPHON_ETC("aft", "Author of afterword, colophon, etc."),

    /**
     * Use for a person or organization responsible for the dialog or spoken commentary for a screenplay or sound
     * recording.
     */
    AUTHOR_OF_DIALOG("aud", "Author of dialog"),

    /**
     * Use for a person or organization responsible for an introduction, preface, foreword, or other critical
    ...
    /**
     * Use for a person or organization responsible for a work upon which the work represented by the catalog record is
     * based. This may be appropriate for adaptations, sequels, continuations, indexes, etc.
     */
    ...
    /**
     * Use for the named entity responsible for writing a commendation or testimonial for a work, which appears on or
    ...
    /**
     * Use for a person or organization responsible for the entire graphic design of a book, including arrangement of
     * type and illustration, choice of materials, and process used.
     */
    ...
    /**
     * Use for a person or organization responsible for the design of flexible covers designed for or published with a
    ...
    /**
     * Use for a person or organization responsible for the design of a book owner's identification label that is most
     * commonly pasted to the inside front cover of a book.
     */
    BOOKPLATE_DESIGNER("bpd", "Bookplate designer"),

    /**
     * Use for a person or organization who makes books and other bibliographic materials available for purchase.
    ...
    /**
     * Use for a person or organization who composes or arranges dances or other movements (e.g., "master of swords")
     * for a musical or dramatic presentation or entertainment.
     */
    CHOREOGRAPHER("chr", "Choreographer"),

    /**
     * Use for a person or organization who is in charge of the images captured for a motion picture film. The
     * cinematographer works under the supervision of a director, and may also be referred to as director of
    ...
    /**
     * Use for a person or organization that takes a limited part in the elaboration of a work of another person or
     * organization that brings complements (e.g., appendices, notes) to the work.
     */
    ...
    /**
     * Use for the named entity responsible for applying color to drawings, prints, photographs, maps, moving images,
     * etc.
     */
    COLORIST("clr", "Colorist"),

    /**
     * Use for a person or organization who provides interpretation, analysis, or a discussion of the subject matter on
     * a recording, motion picture, or other audiovisual medium.
     */
    ...
    /**
     * Use for a person or organization who produces a work or publication by selecting and putting together material
    ...
    /**
     * Use for a complainant who takes an appeal from one court or jurisdiction to another to reverse the judgment,
     * usually in an equity proceeding.
     */
    COMPLAINANT_APPELLANT("cpt", "Complainant-appellant"),

    /**
     * Use for a complainant against whom an appeal is taken from one court or jurisdiction to another to reverse the
     * judgment, usually in an equity proceeding.
     */
    COMPLAINANT_APPELLEE("cpe", "Complainant-appellee"),

    /**
     * Use for a person or organization who creates a musical work, usually a piece of music in manuscript or printed
     * form.
     */
    COMPOSER("cmp", "Composer"),

    /**
     * Use for a person or organization responsible for the creation of metal slug, or molds made of other materials,
     * used to produce the text and images in printed matter.
     */
    COMPOSITOR("cmt", "Compositor"),

    /**
     * Use for a person or organization responsible for the original idea on which a work is based, this includes the
     * scientific author of an audio-visual item and the conceptor of an advertisement.
     */
    CONCEPTOR("ccp", "Conceptor"),

    /**
     * Use for a person who directs a performing group (orchestra, chorus, opera, etc.) in a musical or dramatic
     * presentation or entertainment.
     */
    CONDUCTOR("cnd", "Conductor"),

    /**
     * Use for the named entity responsible for documenting, preserving, or treating printed or manuscript material,
     * works of art, artifacts, or other media.
     */
    CONSERVATOR("con", "Conservator"),

    /**
     * Use for a person or organization relevant to a resource, who is called upon for professional advice or services
     * in a specialized field of knowledge or training.
     */
    CONSULTANT("csl", "Consultant"),

    /**
     * Use for a person or organization relevant to a resource, who is engaged specifically to provide an intellectual
     * overview of a strategic or operational task and by analysis, specification, or instruction, to create or propose
     * a cost-effective course of action or solution.
     */
    ...
    /**
     * Use for a contestant who takes an appeal from one court of law or jurisdiction to another to reverse the
     * judgment.
     */
    CONTESTANT_APPELLANT("cot", "Contestant-appellant"),

    /**
     * Use for a contestant against whom an appeal is taken from one court of law or jurisdiction to another to reverse
     * the judgment.
     */
    CONTESTANT_APPELLEE("coe", "Contestant-appellee"),

    /**
     * Use for the party defending a claim, decision, result, etc. being opposed, resisted, or disputed in a court of
     * law.
     */
    ...
    /**
     * Use for a contestee against whom an appeal is taken from one court or jurisdiction to another to reverse the
     * judgment.
     */
    CONTESTEE_APPELLEE("cte", "Contestee-appellee"),

    /**
     * Use for a person or organization relevant to a resource, who enters into a contract with another person or
     * organization to perform a specific task.
     */
    CONTRACTOR("ctr", "Contractor"),

    /**
     * Use for a person or organization one whose work has been contributed to a larger work, such as an anthology,
     * serial publication, or other compilation of individual works. Do not use if the sole function in relation to a
     * work is as author, editor, compiler or translator.
     */
    CONTRIBUTOR("ctb", "Contributor"),

    /**
     * Use for a person or organization listed as a copyright owner at the time of registration. Copyright can be
     * granted or later transferred to another person or organization, at which time the claimant becomes the copyright
     * holder.
     */
    COPYRIGHT_CLAIMANT("cpc", "Copyright claimant"),

    /**
     * Use for a person or organization to whom copy and legal rights have been granted or transferred for the
     * intellectual content of a work. The copyright holder, although not necessarily the creator of the work, usually
     * has the exclusive right to benefit financially from the sale and use of the work to which the associated
     * copyright protection applies.
     */
    COPYRIGHT_HOLDER("cph", "Copyright holder"),

    /**
     * Use for a person or organization who is a corrector of manuscripts, such as the scriptorium official who
    ...
    /**
     * Use for a person or organization who designs or makes costumes, fixes hair, etc., for a musical or dramatic
     * presentation or entertainment.
     */
    COSTUME_DESIGNER("cst", "Costume designer"),

    /**
     * Use for a person or organization responsible for the graphic design of a book cover, album cover, slipcase, box,
    ...
    /**
     * Use for the party defending or denying allegations made in a suit and against whom relief or recovery is sought
     * in the courts, usually in a legal action.
     */
    DEFENDANT("dfd", "Defendant"),

    /**
     * Use for a defendant who takes an appeal from one court or jurisdiction to another to reverse the judgment,
     * usually in a legal action.
     */
    DEFENDANT_APPELLANT("dft", "Defendant-appellant"),

    /**
     * Use for a defendant against whom an appeal is taken from one court or jurisdiction to another to reverse the
    ...
    /**
     * Use for a person or organization placing material in the physical custody of a library or repository without
     * transferring the legal title.
     */
    DEPOSITOR("dpt", "Depositor"),

    /**
     * Use for a person or organization responsible for the design if more specific codes (e.g., [bkd], [tyd]) are not
     * desired.
     */
    DESIGNER("dsr", "Designer"),

    /**
     * Use for a person or organization who is responsible for the general management of a work or who supervises the
     * production of a performance for stage, screen, or sound recording.
     */
    ...
    /**
     * Use for a person or organization who is the donor of a book, manuscript, etc., to its present owner. Donors to
     * previous owners are designated as Former owner [fmo] or Inscriber [ins].
     */
    DONOR("dnr", "Donor"),
    ...
    /**
     * Use for a person responsible for setting up a lighting rig and focusing the lights for a production, and running
     * the lighting at a performance.
     */
    ELECTRICIAN("elg", "Electrician"),

    /**
     * Use for a person or organization who creates a duplicate printing surface by pressure molding and
     * electrodepositing of metal that is then backed up with lead for printing.
     */
    ELECTROTYPER("elt", "Electrotyper"),

    /**
     * Use for a person or organization that is responsible for technical planning and design, particularly with
     * construction.
     */
    ENGINEER("eng", "Engineer"),

    /**
     * Use for a person or organization who cuts letters, figures, etc. on a surface, such as a wooden or metal plate,
     * for printing.
     */
    ENGRAVER("egr", "Engraver"),

    /**
     * Use for a person or organization who produces text or images for printing by subjecting metal, glass, or some
    ...
    /**
     * Use for a person or organization in charge of the description and appraisal of the value of goods, particularly
    ...
    /**
     * Use for a person or organization that manages or supervises the work done to collect raw data or do research in
     * an actual setting or environment (typically applies to the natural and social sciences).
     */
    FIELD_DIRECTOR("fld", "Field director"),

    /**
     * Use for a person or organization who is an editor of a motion picture film. This term is used regardless of the
     * medium upon which the motion picture is produced or manufactured (e.g., acetate film, video tape).
     */
    FILM_EDITOR("flm", "Film editor"),

    /**
     * Use for a person or organization who is identified as the only party or the party of the first part. In the case
     * of transfer of right, this is the assignor, transferor, licensor, grantor, etc. Multiple parties can be named
     * jointly as the first party
     */
    FIRST_PARTY("fpy", "First party"),

    /**
     * Use for a person or organization who makes or imitates something of value or importance, especially with the
     * intent to defraud.
     */
    FORGER("frg", "Forger"),

    /**
     * Use for a person or organization who owned an item at any time in the past. Includes those to whom the material
     * was once presented. A person or organization giving the item to the present owner is designated as Donor [dnr]
     */
    ...
    /**
     * Use for a person responsible for geographic information system (GIS) development and integration with global
    ...
    /**
     * Use for a person who is invited or regularly leads a program (often broadcast) that includes other guests,
     * performers, etc. (e.g., talk show host).
     */
    HOST("hst", "Host"),

    /**
     * Use for a person or organization responsible for the decoration of a work (especially manuscript material) with
     * precious metals or color, usually with elaborate designs and motifs.
     */
    ...
    /**
     * Use for a person or organization who principally plays an instrument in a musical or dramatic presentation or
     * entertainment.
     */
    INSTRUMENTALIST("itr", "Instrumentalist"),

    /**
     * Use for a person or organization who is interviewed at a consultation or meeting, usually by a reporter,
     * pollster, or some other information gathering agent.
     */
    INTERVIEWEE("ive", "Interviewee"),

    /**
     * Use for a person or organization who acts as a reporter, pollster, or other information gathering agent in a
     * consultation or meeting involving one or more individuals.
     */
    INTERVIEWER("ivr", "Interviewer"),

    /**
     * Use for a person or organization who first produces a particular useful item, or develops a new process for
    ...
    /**
     * Use for a person or organization whose work involves coordinating the arrangement of existing and proposed land
    ...
    /**
     * Use for a person or organization permitting the temporary use of a book, manuscript, etc., such as for
    ...
    /**
     * Use for a libelant who takes an appeal from one ecclesiastical court or admiralty to another to reverse the
     * judgment.
     */
    LIBELANT_APPELLANT("lit", "Libelant-appellant"),

    /**
     * Use for a libelant against whom an appeal is taken from one ecclesiastical court or admiralty to another to
    ...
    /**
     * Use for a libelee who takes an appeal from one ecclesiastical court or admiralty to another to reverse the
     * judgment.
     */
    LIBELEE_APPELLANT("let", "Libelee-appellant"),

    /**
     * Use for a libelee against whom an appeal is taken from one ecclesiastical court or admiralty to another to
     * reverse the judgment.
     */
    ...
    /**
     * Use for a person or organization who designs the lighting scheme for a theatrical presentation, entertainment,
     * motion picture, etc.
     */
    LIGHTING_DESIGNER("lgd", "Lighting designer"),

    /**
     * Use for a person or organization who prepares the stone or plate for lithographic printing, including a graphic
    ...
    /**
     * Use for a person or organization that makes an artifactual work (an object made or modified by one or more
     * persons). Examples of artifactual works include vases, cannons or pieces of furniture.
     */
    MANUFACTURER("mfr", "Manufacturer"),

    /**
     * Use for the named entity responsible for marbling paper, cloth, leather, etc. used in construction of a
     * resource.
     */
    MARBLER("mrb", "Marbler"),
    ...
    /**
     * Use for a person or organization primarily responsible for compiling and maintaining the original description of
    ...
    /**
     * Use for a person who leads a program (often broadcast) where topics are discussed, usually with participation of
     * experts in fields related to the discussion.
     */
    MODERATOR("mod", "Moderator"),

    /**
     * Use for a person or organization that supervises compliance with the contract and is responsible for the report
    ...
    /**
     * Use for a person or organization who performs music or contributes to the musical content of a work when it is
    ...
    /**
     * Use for a person or organization performing the work, i.e., the name of a person or organization associated with
     * the intellectual content of the work. This category does not include the publisher or personal affiliation, or
    ...
    /**
     * Use for a person or organization responsible for the production of paper, usually from wood, cloth, or other
     * fibrous material.
     */
    ...
    /**
     * Use for a plaintiff who takes an appeal from one court or jurisdiction to another to reverse the judgment,
     * usually in a legal proceeding.
     */
    PLAINTIFF_APPELLANT("ptt", "Plaintiff-appellant"),

    /**
     * Use for a plaintiff against whom an appeal is taken from one court or jurisdiction to another to reverse the
     * judgment, usually in a legal proceeding.
     */
    PLAINTIFF_APPELLEE("pte", "Plaintiff-appellee"),

    /**
     * Use for a person or organization responsible for the production of plates, usually for the production of printed
     * images and/or text.
     */
    ...
    /**
     * Use for a person or organization primarily responsible for performing or initiating a process, such as is done
     * with the collection of metadata sets.
     */
    PROCESS_CONTACT("prc", "Process contact"),

    /**
     * Use for a person or organization responsible for the making of a motion picture, including business aspects,
     * management of the productions, and the commercial success of the work.
     */
    ...
    /**
     * Use for a person or organization associated with the production (props, lighting, special effects, etc.) of a
     * musical or dramatic presentation or entertainment.
     */
    PRODUCTION_PERSONNEL("prd", "Production personnel"),

    /**
     * Use for a person or organization responsible for the creation and/or maintenance of computer program design
     * documents, source code, and machine-executable digital files and supporting documentation.
     */
    PROGRAMMER("prg", "Programmer"),

    /**
     * Use for a person or organization with primary responsibility for all essential aspects of a project, or that
     * manages a very large project that demands senior level responsibility, or that has overall responsibility for
    ...
    /**
     * Use for a person or organization that makes printed matter, often text, but also printed music, artwork, etc.
     * available to the public.
     */
    PUBLISHER("pbl", "Publisher"),

    /**
     * Use for a person or organization who presides over the elaboration of a collective work to ensure its coherence
    ...
    /**
     * Use for a person or organization who manipulates, controls, or directs puppets or marionettes in a musical or
    ...
    /**
     * Use for a person or organization who writes or develops the framework for an item without being intellectually
     * responsible for its content.
     */
    REDACTOR("red", "Redactor"),

    /**
     * Use for a person or organization who prepares drawings of architectural designs (i.e., renderings) in accurate,
    ...
    /**
     * Use for an agency that hosts data or material culture objects and provides services to promote long term,
    ...
    /**
     * Use for a person who participated in a research project but whose role did not involve direction or management of
     * it.
     */
    ...
    /**
     * Use for the party who makes an answer to the courts pursuant to an application for redress, usually in an equity
     * proceeding.
     */
    RESPONDENT("rsp", "Respondent"),

    /**
     * Use for a respondent who takes an appeal from one court or jurisdiction to another to reverse the judgment,
     * usually in an equity proceeding.
     */
    RESPONDENT_APPELLANT("rst", "Respondent-appellant"),

    /**
     * Use for a respondent against whom an appeal is taken from one court or jurisdiction to another to reverse the
     * judgment, usually in an equity proceeding.
     */
    ...
    /**
     * Use for a person or organization, other than the original choreographer or director, responsible for restaging a
    ...
    /**
     * Use for a person or organization responsible for parts of a work, often headings or opening parts of a
    ...
    /**
     * Use for a person or organization who brings scientific, pedagogical, or historical competence to the conception
     * and realization on a work, particularly in the case of audio-visual items.
     */
    SCIENTIFIC_ADVISOR("sad", "Scientific advisor"),

    /**
     * Use for a person who is an amanuensis and for a writer of manuscripts proper. For a person who makes
    ...
    /**
     * Use for a person or organization who is identified as the party of the second part. In the case of transfer of
     * right, this is the assignee, transferee, licensee, grantee, etc. Multiple parties can be named jointly as the
     * second party.
     */
    SECOND_PARTY("spy", "Second party"),

    /**
     * Use for a person or organization who is a recorder, redactor, or other person responsible for expressing the
     * views of a organization.
     */
    SECRETARY("sec", "Secretary"),

    /**
     * Use for a person or organization who translates the rough sketches of the art director into actual architectural
     * structures for a theatrical presentation, entertainment, motion picture, etc. Set designers draw the detailed
     * guides and specifications for building the set.
     */
    ...
    /**
     * Use for a person or organization who uses his/her/their voice with or without instrumental accompaniment to
     * produce music. A performance may or may not include actual words.
     */
    SINGER("sng", "Singer"),

    /**
     * Use for a person who produces and reproduces the sound score (both live and recorded), the installation of
    ...
    /**
     * Use for a person who participates in a program (often broadcast) and makes a formalized contribution or
     * presentation generally prepared in advance.
     */
    SPEAKER("spk", "Speaker"),

    /**
     * Use for a person or organization that issued a contract or under the auspices of which a work has been written,
     * printed, published, etc.
     */
    SPONSOR("spn", "Sponsor"),

    /**
     * Use for a person who is in charge of everything that occurs on a performance stage, and who acts as chief of all
    ...
    /**
     * Use for a person or organization who creates a new plate for printing by molding or copying another printing
     * surface.
     */
    ...
    /**
     * Use for a person or organization that supports (by allocating facilities, staff, or other resources) a project,
    ...
    /**
     * Use for a person or organization who does measurements of tracts of land, etc. to determine location, forms, and
     * boundaries.
     */
    SURVEYOR("srv", "Surveyor"),

    /**
     * Use for a person who, in the context of a resource, gives instruction in an intellectual subject or demonstrates
     * while teaching physical skills.
     */
    TEACHER("tch", "Teacher"),
    ...
    /**
     * Use for a person who prepares a handwritten or typewritten copy from original material, including from dictated
     * or orally recorded material. For makers of pen-facsimiles, use Facsimilist [fac].
     */
    TRANSCRIBER("trc", "Transcriber"),

    /**
     * Use for a person or organization who renders a text from one language into another, or from an older form of a
    ...
    /**
     * Use for the name of a place where a university that is associated with a resource is located, for example, a
     * university where an academic dissertation or thesis was presented.
     */
    UNIVERSITY_PLACE("uvp", "University place"),

    /**
     * Use for a person or organization in charge of a video production, e.g. the video recording of a stage production
     * as opposed to a commercial motion picture. The videographer may be the camera operator or may supervise one or
     * more camera operators. Do not confuse with cinematographer.
     */
    VIDEOGRAPHER("vdg", "Videographer"),

    /**
     * Use for a person or organization who principally exhibits singing skills in a musical or dramatic presentation or
     * entertainment.
     */
    ...
    /**
     * Use for a person or organization who makes prints by cutting the image in relief on the end-grain of a wood
     * block.
     */
    WOOD_ENGRAVER("wde", "Wood-engraver"),

    /**
     * Use for a person or organization who makes prints by cutting the image in relief on the plank side of a wood
     * block.
     */
    WOODCUTTER("wdc", "Woodcutter"),

    /**
     * Use for a person or organization who writes significant material which accompanies a sound recording or other
