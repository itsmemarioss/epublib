...
public class Identifier extends DcmesElement {
    ...
    /**
     * The first identifier for which the bookId is true is made the bookId identifier. If no identifier has bookId ==
     * true then the first bookId identifier is written as the primary.
     * @param identifiers
    ...
    /**
     * This bookId property allows the book creator to add multiple ids and tell the epubwriter which one to write out
     * as the bookId.
     * <p>
     * The Dublin Core metadata spec allows multiple identifiers for a Book. The epub spec requires exactly one
