 ...
 * <p>
 * It helps moving from one resource to the other, from one resource to the other and keeping other elements of the
 * application up-to-date by calling the NavigationEventListeners.
 * @author paul
 */
