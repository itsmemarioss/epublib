 ...
 * <p>
 * Most of the functions herein are re-implementations of the ones in apache commons StringUtils. The reason for
 * re-implementing this is that the functions are fairly simple and using my own implementation saves the inclusion of a
 * 200Kb jar file.
...
public class StringUtil {
    ...
    /**
     * Changes a path containing '..', '.' and empty dirs into a path that doesn't. X/foo/../Y is changed into 'X/Y',
     * etc. Does not handle invalid paths like "../".
     * @param path
