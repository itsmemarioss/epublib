...
/**
 * Most of the functions herein are re-implementations of the ones in apache io IOUtils. The reason for re-implementing
 * this is that the functions are fairly simple and using my own implementation saves the inclusion of a 200Kb jar
 * file.
 */
public class IOUtil {
     ...
     * <p>
     * This is meant for situations where memory is tight, since it prevents buffer expansion.
