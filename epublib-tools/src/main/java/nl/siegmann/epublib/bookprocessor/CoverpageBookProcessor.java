...
/**
 * If the book contains a cover image then this will add a cover page to the book. If the book contains a cover html
 * page it will set that page's first image as the book's cover image.
 * <p>
...
//    }
    ...
    private String createCoverpageHtml(String title, String imageHref) {
        return "" +
                ...
                "\t<body>\n" +
                "\t\t<div id=\"cover-image\">\n" +
                "\t\t\t<img src=\"" + StringEscapeUtils.escapeHtml(imageHref) + "\" alt=\"" +
    ...
    private Dimension calculateResizeSize(BufferedImage image) {
        ...
        if (image.getWidth() > image.getHeight()) {
            result = new Dimension(MAX_COVER_IMAGE_SIZE,
                    (int) (((double) MAX_COVER_IMAGE_SIZE / (double) image.getWidth()) * (double) image.getHeight()));
        } else {
            result = new Dimension(
                    (int) (((double) MAX_COVER_IMAGE_SIZE / (double) image.getHeight()) * (double) image.getWidth()),
    ...
    private byte[] createThumbnail(byte[] imageData) throws IOException {
        ...
        BufferedImage thumbnailImage = createResizedCopy(originalImage, (int) thumbDimension.getWidth(),
                (int) thumbDimension.getHeight(), false);
