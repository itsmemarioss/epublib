...
public class ChmParser {
    ...
    public static Book parseChm(FileObject chmRootDir) throws XPathExpressionException, IOException,
     ...
     * than 3 characters long. Assumes that that is then the title of the book.
     * @param chmRootDir
     * @return Finds in the '#SYSTEM' file the 3rd set of characters that have ascii value &gt;= 32 and &gt;= 126
     * and is
